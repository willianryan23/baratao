  ...
  <nav class="navbar navbar-expand-lg text-body-emphasis fixed-top navColor">
          ...
          <div class="col-sm-4">
            <div class="container">
              <a class="navbar-brand" href="#">
                <img src="../assets/img/logo emporio com fundo.jpg" alt="Bootstrap" width="30" height="24">
              </a>
            </div>
          </div>
          <div class="col-sm-4">
            <ul class="navbar-nav text-center">
              ...
              <li class="nav-item"><a class="nav-link text-light" href="sobre.php">Sobre</a></li>
            </ul>
          </div>
          <div class="col-sm-4">
